...
impl Manager {
    ...
    /// Listen for logind PrepareForSleep signals on the system D-Bus.
    /// Sends SystemSleep / SystemWake commands when the system is about to
    /// suspend or has just resumed, so source devices can pause polling.
